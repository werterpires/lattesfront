...
@Component({
  selector: 'app-participacoes-em-encontros',
  standalone: true,
  imports: [
    NgFor,
    NgIf,
  ...
  templateUrl: './participacoes-em-encontros.component.html',
  styleUrl: './participacoes-em-encontros.component.css'
})
export class ParticipacoesEmEncontrosComponent {
  curriculumns: ICurriculum[] = []
  participations: Participacao[] = []
  tableElements: ITableElements[] = [
    {
      title: 'Participações em encontros',
      property: 'participaçõesEmEncontros'
    }
  ]
  ...
  countOutrasParticipacoesEmEventos(curriculum: ICurriculum): number {
    return curriculum.curriculum.participacoesEmEncontros.length
  }
    ...
    this.participations = this.curriculumns.reduce<Participacao[]>(
      (participations, curriculum) =>
        participations.concat(
          curriculum.curriculum.participacoesEmEncontros.map(
            (participation) => ({
