...
import { AreasDoConhecimento, ParticipacaoEmSeminario } from './objTypes'
import { UtilsService } from './util.service'

@Injectable({
  providedIn: 'root'
})
export class ParticipationInSeminaryService {
  constructor(private readonly utilsService: UtilsService) {}
  makeParticipacoesEmSeminarios(data: any[]): ParticipacaoEmSeminario[] {
    const participations: ParticipacaoEmSeminario[] = []
    data.forEach((element) => {
      ...
      const participation: ParticipacaoEmSeminario = {
        palavrasChave,
        areasDoConhecimento,
        ...
        natureza:
          element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._NATUREZA,
        titulo: element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._TITULO,
        ano: element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._ANO,
        pais: element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._PAIS,
        idioma: element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._IDIOMA,
        meioDeDivulgacao:
          element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO'][
            '_MEIO-DE-DIVULGACAO'
          ],
        homePageDoTrabalho:
          element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO'][
        ...
        doi: element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO']._DOI,
        tituloIngles:
          element['DADOS-BASICOS-DA-PARTICIPACAO-EM-SEMINARIO'][
            '_TITULO-INGLES'
          ],
        ...
        nomeDoEvento:
          element['DETALHAMENTO-DA-PARTICIPACAO-EM-SEMINARIO'][
            '_NOME-DO-EVENTO'
          ],
        codigoInstituicao:
          element['DETALHAMENTO-DA-PARTICIPACAO-EM-SEMINARIO'][
  ...
  countParticipationsByProfessorAndYear(
    professor: string,
    year: string,
    participations: ParticipacaoEmSeminario[]
  ): number {
