...
export class EventsWorksService {
  makeTrabalhoEmEvento(data: any[]): TrabalhoEmEventos[] {
    ...
    data.forEach((element) => {
      ...
      if (element['AREAS-DO-CONHECIMENTO']) {
        areasDoConhecimento = this.makeAreasDoConhecimento(element['AREAS-DO-CONHECIMENTO'])
      }
      ...
      const work: TrabalhoEmEventos = {
        ...
        tituloDoTrabalho: element['DADOS-BASICOS-DO-TRABALHO']['_TITULO-DO-TRABALHO'],
        ...
        meioDeDivulgacao: element['DADOS-BASICOS-DO-TRABALHO']['_MEIO-DE-DIVULGACAO'],
        homePageDoTrabalho: element['DADOS-BASICOS-DO-TRABALHO']['_HOME-PAGE-DO-TRABALHO'],
        flagRelevancia: element['DADOS-BASICOS-DO-TRABALHO']['_FLAG-RELEVANCIA'],
        doi: element['DADOS-BASICOS-DO-TRABALHO']._DOI,
        tituloDoTrabalhoIngles: element['DADOS-BASICOS-DO-TRABALHO']['_TITULO-DO-TRABALHO-INGLES'],
        flagDivulgacaoCientifica:
          element['DADOS-BASICOS-DO-TRABALHO']['_FLAG-DIVULGACAO-CIENTIFICA'],

        classificacaoDoEvento: element['DETALHAMENTO-DO-TRABALHO']['_CLASSIFICACAO-DO-EVENTO'],
        nomeDoEvento: element['DETALHAMENTO-DO-TRABALHO']['_NOME-DO-EVENTO'],
        cidadeDoEvento: element['DETALHAMENTO-DO-TRABALHO']['_CIDADE-DO-EVENTO'],
        anoDeRealizacao: element['DETALHAMENTO-DO-TRABALHO']['_ANO-DE-REALIZACAO'],
        tituloDosAnaisOuProceedings:
          element['DETALHAMENTO-DO-TRABALHO']['_TITULO-DOS-ANAIS-OU-PROCEEDINGS'],
        ...
        cidadeDaEditora: element['DETALHAMENTO-DO-TRABALHO']['_CIDADE-DA-EDITORA'],
        nomeDoEventoIngles: element['DETALHAMENTO-DO-TRABALHO']['_NOME-DO-EVENTO-INGLES'],
        autores,
        palavrasChave,
        areasDoConhecimento,
  ...
  countWorksByProfessorAndYear(
    ...
    return eventsWorks.filter((work) => {
      return work.anoDeRealizacao === year && (work.nome === professor || !work.nome)
    }).length
  }
  ...
  makePalavrasChave(data: any): string[] {
  ...
  makeAreasDoConhecimento(data: any): AreasDoConhecimento {
    ...
    if (data['AREA-DO-CONHECIMENTO-1']) {
      areasDoConhecimento.areaDoConhecimento1 = {
        ...
        nomeDaAreaDoConhecimento: data['AREA-DO-CONHECIMENTO-1']['_NOME-DA-AREA-DO-CONHECIMENTO'],
        nomeDaSubAreaDoConhecimento:
          data['AREA-DO-CONHECIMENTO-1']['_NOME-DA-SUB-AREA-DO-CONHECIMENTO'],
        nomeDaEspecialidade: data['AREA-DO-CONHECIMENTO-1']['_NOME-DA-ESPECIALIDADE']
      }
    }
    if (data['AREA-DO-CONHECIMENTO-2']) {
      areasDoConhecimento.areaDoConhecimento2 = {
        ...
        nomeDaAreaDoConhecimento: data['AREA-DO-CONHECIMENTO-2']['_NOME-DA-AREA-DO-CONHECIMENTO'],
        nomeDaSubAreaDoConhecimento:
          data['AREA-DO-CONHECIMENTO-2']['_NOME-DA-SUB-AREA-DO-CONHECIMENTO'],
        nomeDaEspecialidade: data['AREA-DO-CONHECIMENTO-2']['_NOME-DA-ESPECIALIDADE']
      }
    }
    if (data['AREA-DO-CONHECIMENTO-3']) {
      areasDoConhecimento.areaDoConhecimento3 = {
        ...
        nomeDaAreaDoConhecimento: data['AREA-DO-CONHECIMENTO-3']['_NOME-DA-AREA-DO-CONHECIMENTO'],
        nomeDaSubAreaDoConhecimento:
          data['AREA-DO-CONHECIMENTO-3']['_NOME-DA-SUB-AREA-DO-CONHECIMENTO'],
        nomeDaEspecialidade: data['AREA-DO-CONHECIMENTO-3']['_NOME-DA-ESPECIALIDADE']
      }
    }
