...
import { AreasDoConhecimento, ParticipacaoEmEncontros } from './objTypes'
...
export class ParticipationInMeetingService {
  ...
  makeParticipacoesEmEncontros(data: any[]): ParticipacaoEmEncontros[] {
    const participations: ParticipacaoEmEncontros[] = []
    data.forEach((element) => {
      ...
      const participation: ParticipacaoEmEncontros = {
        palavrasChave,
        areasDoConhecimento,
  ...
  countParticipationsByProfessorAndYear(
    professor: string,
    year: string,
    participations: ParticipacaoEmEncontros[]
  ): number {
